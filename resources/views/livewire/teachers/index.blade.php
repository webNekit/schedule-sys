            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
                ...
                <div class="p-6 space-y-6">
                    <div class="text-sm text-gray-600 dark:text-gray-400 space-y-2">
                        <p>Для корректного импорта преподавателей, пожалуйста, используйте наш стандартный шаблон.</p>
                        <p>Заполните данные: ФИО, отделение, должность и ставку. Система автоматически создаст новые записи или обновит существующие.</p>
                    </div>

                    <div class="flex flex-col gap-3">
                        <a href="{{ asset('template/teachers_template.xlsx') }}" download
