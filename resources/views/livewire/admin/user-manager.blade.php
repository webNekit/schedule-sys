            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
                ...
                <form wire:submit="save" class="p-6 space-y-5">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium mb-1">Пароль <span class="text-red-500">*</span></label>
                            ...
                            <p class="text-xs text-gray-400 mt-1">{{ $editId ? 'Необязательное поле' : 'Минимум 8 символов' }}</p>
                            @error('password') <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p> @enderror
                        </div>
                        <div>
                            <label class="block text-sm font-medium mb-1">Подтверждение <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="block text-sm font-medium mb-2">Роли <span class="text-red-500">*</span></label>
