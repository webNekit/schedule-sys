...
| 70 | 2026-05-14 | **Advanced Automation:** Реализована поддержка подгрупп (split lessons) в генераторе | ✅ |
| 71 | 2026-05-14 | **Monitoring:** Добавлена тепловая карта (Heatmap) для контроля 67 групп в реальном времени | ✅ |
| 72 | 2026-05-14 | **Replacement:** Реализован "Engine" поиска замен с учетом доступности и близости кабинета | ✅ |
| 73 | 2026-05-14 | **Branch:** Все изменения вынесены в ветку `feature/advanced-automation` | ✅ |
